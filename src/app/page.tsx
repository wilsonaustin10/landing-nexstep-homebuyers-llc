...
export default function Home() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      {/* Hero Section */}
      <section id="property-form" className="pt-20 pb-16 px-4 bg-gradient-to-br from-blue-900 to-blue-950">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="text-center p-6 rounded-lg shadow-lg bg-white border-t-4 border-red-600">
