...
export default function TestConversionPage() {
  ...
  const testConversion = () => {
    if (typeof window !== 'undefined' && window.gtag) {
      console.log('Firing conversion with label: 4DprCPfG3ZMbELiiz94_');
      ...
      <div className="max-w-2xl mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <p className="text-gray-600 mb-4">
            This page tests the Google Ads conversion tracking with the label: <code className="bg-gray-100 px-2 py-1 rounded">4DprCPfG3ZMbELiiz94_</code>
          </p>
          <p className="text-gray-600 mb-4">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <ol className="list-decimal list-inside space-y-2 text-sm text-gray-700">
            ...
            <li>The request URL should include: /pagead/1p-conversion/16906023932/?...label=4DprCPfG3ZMbELiiz94_</li>
          </ol>
        </div>
      </div>
    </main>
